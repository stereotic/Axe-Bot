...
// Профиль таких воркеров при переходе по ссылке показывает «Пользователь скрыл профиль».
...
// спец-диапазоном id, чтобы просмотр профиля отдавал «Пользователь скрыл профиль».
