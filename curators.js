...
const mentors = [
  {
    ...
    description: `Индивидуально подхожу к каждому подопечному, подробно разбираем не только специфику направления но и нюансы социальной инженерии. Отвечу на все ваши вопросы и развею все ваши сомнения касательно ворка и направления в целом. Прокачаем ваши сильные стороны и проработаем слабые, покажу и расскажу секреты трафика, поделюсь личными наработками. Все происходит на практике, любые теоретические знания будем закреплять не только практикой, а конкретными цифрами профитов. Доведу за руку до первых результатов новичков сферы.`,
...
• Гибкое мышление в работе с мамонтами
